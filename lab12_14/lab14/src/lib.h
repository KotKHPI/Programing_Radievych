 ...
 */
void get_symbols(char* strIn, int sizeIn, char* symbols, FILE *sentence);
/**
...
/**
 *Функція визвачення розміру файлу
 *
 *Функція визначає розмір заданного файлу в байтах
 */
void check_file(FILE *sentence);
/**
 *Функція перевірки деректорії файлу
 *
 *Функція перевіряє наявність файлу в заданій дерикторії
 */
